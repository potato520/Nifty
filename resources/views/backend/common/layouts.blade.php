...
<head>
    ...
    <link href="{{ asset('Nifty/plugins/bootstrap-table/bootstrap-table.min.css') }}" rel="stylesheet">


    <!--X-editable [ OPTIONAL ]-->
    <link href="{{ asset('Nifty/plugins/x-editable/css/bootstrap-editable.css') }}" rel="stylesheet">

    <link href="{{ asset('Nifty/plugins/ionicons/css/ionicons.min.css') }}" rel="stylesheet">
    ...
    <script src="{{ asset('Nifty/js/demo/nifty-demo.min.js') }}"></script>

    
    <!--Bootstrap Table Sample [ SAMPLE ]-->
    <script src="{{ asset('Nifty/js/demo/tables-bs-table.js') }}"></script>


    <!--X-editable [ OPTIONAL ]-->
    <script src="{{ asset('Nifty/plugins/x-editable/js/bootstrap-editable.min.js') }}"></script>


    <!--Bootstrap Table [ OPTIONAL ]-->
    <script src="{{ asset('Nifty/plugins/bootstrap-table/bootstrap-table.min.js') }}"></script>


    <!--Bootstrap Table Extension [ OPTIONAL ]-->
    <script src="{{ asset('Nifty/plugins/bootstrap-table/extensions/editable/bootstrap-table-editable.js') }}"></script>
    ...
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
                                    ...
                                    <div class="nano-content">
                                        <ul class="head-list">
                                            ...
                                            <li class="bg-gray">
                                                <a class="media" href="#">
                                                    <div class="media-left">
                                                        <img class="img-circle img-sm" alt="Profile Picture" src="{{ asset('Nifty/img/profile-photos/9.png') }}">
                                                    </div>
                                                    <div class="media-body">
                                            ...
                                            <li class="bg-gray">
                                                <a class="media" href="#">
                                                    <div class="media-left">
                                                        <img class="img-circle img-sm" alt="Profile Picture" src="{{ asset('Nifty/img/profile-photos/3.png') }}">
                                                    </div>
                                                    <div class="media-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        ...
                                        <ul class="list-unstyled list-inline text-justify">
                                            ...
                                            <li class="pad-btm">
                                                <img src="{{ asset('Nifty/img//thumbs/mega-menu-2.jpg') }}" alt="thumbs">
                                            </li>
                                            <li class="pad-btm">
                                                <img src="{{ asset('Nifty/img//thumbs/mega-menu-3.jpg') }}" alt="thumbs">
                                            </li>
                                            <li class="pad-btm">
                                                <img src="{{ asset('Nifty/img//thumbs/mega-menu-1.jpg') }}" alt="thumbs">
                                            </li>
                                            <li class="pad-btm">
                                                <img src="{{ asset('Nifty/img//thumbs/mega-menu-4.jpg') }}" alt="thumbs">
                                            </li>
                                            <li class="pad-btm">
                                                <img src="{{ asset('Nifty/img//thumbs/mega-menu-5.jpg') }}" alt="thumbs">
                                            </li>
                                            <li class="pad-btm">
                                                <img src="{{ asset('Nifty/img//thumbs/mega-menu-6.jpg') }}" alt="thumbs">
                                            </li>
                                        </ul>
                        ...
                        <li class="dropdown">
                            <a id="demo-lang-switch" class="lang-selector dropdown-toggle" href="#" data-toggle="dropdown">
                                <span class="lang-selected">
                                    <img class="lang-flag" src="{{ asset('Nifty/img/flags/united-kingdom.png') }}" alt="English">
                                </span>
                            </a>
                            ...
                            <ul class="head-list dropdown-menu">
						        ...
						        <li>
						            <!--France-->
						            <a href="#">
						                <img class="lang-flag" src="{{ asset('Nifty/img/flags/france.png') }}" alt="France">
						        ...
						        <li>
						            <!--Germany-->
						            <a href="#">
						                <img class="lang-flag" src="{{ asset('Nifty/img/flags/germany.png') }}" alt="Germany">
						        ...
						        <li>
						            <!--Italy-->
						            <a href="#">
						                <img class="lang-flag" src="{{ asset('Nifty/img/flags/italy.png') }}" alt="Italy">
						        ...
						        <li>
						            <!--Spain-->
						            <a href="#">
						                <img class="lang-flag" src="{{ asset('Nifty/img/flags/spain.png') }}" alt="Spain">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <!--
                <div id="page-title">
                    <h1 class="page-header text-overflow">Bootstrap Tables</h1>
                                    ...
                                    <div class="list-group bg-trans">
							            <a href="#" class="list-group-item">
							                <div class="media-left pos-rel">
							                    <img class="img-circle img-xs" src="{{ asset('Nifty/img/profile-photos/2.png') }}" alt="Profile Picture">
							            ...
							            <a href="#" class="list-group-item">
							                <div class="media-left pos-rel">
							                    <img class="img-circle img-xs" src="{{ asset('Nifty/img/profile-photos/7.png') }}" alt="Profile Picture">
							                </div>
							                <div class="media-body">
							            ...
							            <a href="#" class="list-group-item">
							                <div class="media-left pos-rel">
							                    <img class="img-circle img-xs" src="{{ asset('Nifty/img/profile-photos/1.png') }}" alt="Profile Picture">
							            ...
							            <a href="#" class="list-group-item">
							                <div class="media-left pos-rel">
							                    <img class="img-circle img-xs" src="{{ asset('Nifty/img/profile-photos/4.png') }}" alt="Profile Picture">
							                </div>
							                <div class="media-body">
							            ...
							            <a href="#" class="list-group-item">
							                <div class="media-left pos-rel">
							                    <img class="img-circle img-xs" src="{{ asset('Nifty/img/profile-photos/8.png') }}" alt="Profile Picture">
							            ...
							            <a href="#" class="list-group-item">
							                <div class="media-left pos-rel">
							                    <img class="img-circle img-xs" src="{{ asset('Nifty/img/profile-photos/9.png') }}" alt="Profile Picture">
